...
export default function ReviewHistoryModal({ isOpen, onClose, card }: ReviewHistoryModalProps) {
        ...
        <div className="overflow-y-auto max-h-[60vh]">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400 mt-1">開始複習這張卡片來建立學習歷史</p>
            </div>
          ) : (
            <div className="space-y-4">
                  ...
                  <CardContent className="p-4">
                    ...
                    {review.reviewNotes && (
                      <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                        <p className="text-sm text-gray-700 font-medium mb-1">複習心得：</p>
